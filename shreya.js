...
var music=new Audio('music/shreya_songs/1.mp3');
...
const songs=[
    {
        id:1,
        songName:`Guli Mata<br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/1.jpg"
    },
    {
        id:2,
        ...
        poster:"images/shreya_images/2.jpg"
    },
    {
        id:3,
        songName:`Meri Jaan <br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/3.jpg"
    },
    {
        id:4,
        songName:`Barshat aa gayi<br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/4.jpg"
    },
    {
        id:5,
        songName:`Tu h sheetal dhara <br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/5.jpg"
    },
    {
        id:6,
        songName:`O doli leke aaja <br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/6.jpg"
    },
    {
        id:7,
        songName:`Zihal E miskin<br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/7.jpg"
    },
    {
        id:8,
        songName:`Veera raja veera <br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/8.jpg"
    },
    {
        id:9,
        songName:`Likh likh k tera naam<br> <div class="subtitle">
        Shreya Ghosal
   </div>`,
        poster:"images/shreya_images/9.jpg"
    },
//     {
//         id:10,
...
Array.from(document.getElementsByClassName('playlistplay')).forEach((e)=>{
    e.addEventListener('click',(e1)=>{
        index=e1.target.id;
        // console.log(index);
        music.src=`music/shreya_songs/${index}.mp3`;
        poster_master_play.src=`images/shreya_images/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');

        music_download.href=`music/shreya_songs/${index}.mp3`;
