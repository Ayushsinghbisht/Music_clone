...
var music=new Audio('music/bhanusali_songs/1.mp3');
...
const songs=[
    {
        id:1,
        songName:`Uda gulaal<br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/1.jpg"
    },
    {
        id:2,
        songName:`Tumse milna<br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/2.jpg"
    },
    {
        id:3,
        songName:`Tum hi aana <br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/3.jpg"
    },
    {
        id:4,
        songName:`The care concert  <br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/4.jpg"
    },
    {
        id:5,
        songName:`Rula <br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/5.jpg"
    },
    {
        id:6,
        songName:`Radha<br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/6.jpg"
    },
    {
        id:7,
        songName:`Physico<br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/7.jpg"
    },
    {
        id:8,
        songName:`Physico Saiyaan <br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/8.jpg"
    },
    {
        id:9,
        songName:`Parda<br> <div class="subtitle">
        Dhvani Bhanushali
   </div>`,
        poster:"images/bhanusali_images/9.jpg"
    },
//     {
//         id:10,
...
Array.from(document.getElementsByClassName('playlistplay')).forEach((e)=>{
    e.addEventListener('click',(e1)=>{
        index=e1.target.id;
        // console.log(index);
        music.src=`music/bhanusali_songs/${index}.mp3`;
        poster_master_play.src=`images/bhanusali_images/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');

        music_download.href=`music/bhanusali_songs/${index}.mp3`;
